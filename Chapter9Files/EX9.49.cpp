...
int main()
{
    ...
    string asdecender = "bdfhkltgjpqy";
    ...
    for(string temp; inputfile >> temp;)
        if(temp.find_first_of(asdecender) == string::npos)
    ...
    cout << "Largest word with no ascenders or descenders is " << largest << endl;
