...
//   vector<Quote> a;
//
//   a.push_back(Bulk_Quote("shit",2,5,0.5));
//   a.push_back(Bulk_Quote("fuck",2,10,0.5));
//
//   for(const auto& c : a)
//      cout << c.net_price(10) << endl;

    vector<shared_ptr<Quote>> b;

    b.push_back(make_shared<Bulk_Quote>("shit",2,5,0.5));
    b.push_back(make_shared<Bulk_Quote>("fuck",2,10,0.5));
