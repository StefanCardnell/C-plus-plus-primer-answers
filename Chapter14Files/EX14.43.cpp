...
int main(){
    ...
    vector<int> numbers = {2,4,5,5,3,7,2,3,5,6,11};

    int number = 5;

    if(all_of(numbers.cbegin(), numbers.cend(), bind(modulus<int>(), number, placeholders::_1)))
        cout << number << " is not divisible by any element of the vector";
    else
        cout << number << " is divisible by a number in the vector";
