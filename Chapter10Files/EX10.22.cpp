...
bool greaterSz(const std::string& s1, std::string::size_type sz){
...
int main()
{
    std::string::size_type sz = 2;

    std::vector<std::string> words = {"this", "is", "a", "motherfucking", "test"};

    std::cout << count_if(words.begin(), words.end(), bind(greaterSz, _1, sz));
