...
int main(){
    ...
    vector<string> words = {"the", "quick", "brown", "fox", "jumped", "over", "the", "quick", "dog"};

    auto ender = partition(words.begin(), words.end(), fiveChar);

    for(auto it = words.begin(); it != ender; ++it)
        cout << *it << " ";
