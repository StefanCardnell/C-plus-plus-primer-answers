...
int main(){
    ...
    //to write: the first way obviously, much less code and it doesn't need to worry if the element was inserted or not
    //to read: probably still the first way. ++it.first->second is a brutal expression, and worrying about a pair that holds an iterator of a pair and an int...ugh
