...
map<string, string> transformPhrase(ifstream& phrases){
...
const string& returnTransformed(const string& s, const map<string, string>& m){ //we can declare map as const since we aren't using subscript
    auto it = m.find(s);
