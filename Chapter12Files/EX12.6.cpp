...
std::vector<int>* returnDyna(){

    return new std::vector<int>;

}

std::vector<int>* inputElem(std::istream& is, std::vector<int>* p){
...
std::ostream& outputElem(std::ostream& os, const std::vector<int>* p){
...
int main(){
    ...
    std::vector<int>* p = inputElem(std::cin, returnDyna());

    outputElem(std::cout, p);
