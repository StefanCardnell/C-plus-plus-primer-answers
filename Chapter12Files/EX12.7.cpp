...
using dynaVec = std::shared_ptr<std::vector<int>>;
...
dynaVec inputElem(std::istream& is, dynaVec p){
...
std::ostream& outputElem(std::ostream& os, const dynaVec p){
...
int main(){
    ...
    dynaVec p = inputElem(std::cin, returnDyna());
