...
public:
    ...
    /*Constructors not listed as noexcept since (reading definitions) they allocate memory on the heap*/
...
public:
    ...
    /*No issue with noexcept here, weak_ptr constructors are noexcept themselves*/

    strBlobPtr() noexcept : curr(0) { }
    strBlobPtr(strBlob& a, index b = 0) noexcept : ptr(a.data), curr(b) { }
...
public:
    ...
    strBlobPtrConst() noexcept : curr(0) { }
    strBlobPtrConst(const strBlob& a, index b = 0) noexcept : ptr(a.data), curr(b) { }
