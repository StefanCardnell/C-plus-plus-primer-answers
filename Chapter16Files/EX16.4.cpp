...
template <typename I, typename V> I customFind(I beg, I end, const V& value){
    for(; beg != end; ++beg)
...
int main(){
   ...
   vector<int> a = {1,2,4,1,4,5,76,12,76,1,5};

   list<string> b = {"girls", "just", "wanna", "have", "fun"};



   cout << *(customFind(a.begin(), a.end(), 100)) << " " << *(customFind(b.begin(), b.end(), "just"));
