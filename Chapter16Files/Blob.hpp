...
public:
    ...
    Blob(std::initializer_list<T> li): data(std::make_shared<std::vector<T>>(li)) { }
...
public:
    ...
    BlobPtr(): curr(0) { }
    BlobPtr(Blob<T>& a, size_type i = 0): curr(i), ptr(a.data)  { }
...
public:
    ...
    BlobPtrConst(): curr(0) { }
    BlobPtrConst(const Blob<T>& a, size_type i = 0): curr(i), ptr(a.data) { }
